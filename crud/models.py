...
class Users(models.Model):
    ...
    full_name = models.CharField(max_length=55, blank=False) # full name VARCHAR(55) NOT NULL
    ...
    contact_number = models.CharField(max_length=55, blank=False) # contact number VARCHAR(55) NOT NULL
